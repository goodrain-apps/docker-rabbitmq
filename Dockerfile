...
RUN usermod -d /var/lib/rabbitmq rain
...
RUN export http_proxy=http://203.88.170.137:18888 && export  https_proxy=https://203.88.170.137:18888 &&curl -o /usr/local/bin/gosu -SL "https://github.com/tianon/gosu/releases/download/1.6/gosu-$(dpkg --print-architecture)" \
